...
pub use duplicates::{
    default_file_workers, estimated_partial_read, hash_targets_from_records, mark_confirmed_groups,
    mark_group_with_records, run_duplicate_cascade, run_duplicate_cascade_default,
    run_duplicate_cascade_with_cache, run_full_hash_stage, run_full_hash_stage_cached,
    run_full_hash_stage_gated, run_partial_hash_stage, run_partial_hash_stage_cached,
    run_partial_hash_stage_gated, run_size_stage, run_size_stage_from_index,
    spawn_duplicate_cascade, spawn_full_hash_stage, spawn_partial_hash_stage, volume_from_path,
    CascadeResult, CountingHasher, FullHashStageResult, HashTarget, MapHasher, MemoryHashCache,
...
pub use quarantine::{
    ...
    QuarantineRecovery, QuarantineRestorer, QuarantineSweeper, ReapOutcome, ReapRequest,
    RecoveryResult, RestoreOutcome, RestoreRequest, SweepResult, TransactionalReaper,
};
